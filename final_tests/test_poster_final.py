...
wrong_directory = "/mnt/d/datasets/TONO/poster"
false_positive_directory = "/mnt/d/datasets/TONO/poster_fp"
false_negative_directory = "/mnt/d/datasets/TONO/poster_fn"
...
for filename in tqdm(os.listdir(selected_directory)):
    if filename.lower().endswith((".png", ".jpg", ".jpeg")):
        ...
        is_posterized = quality_checker.is_posterized(img_path)

        files.append(img_path)
        y_pred.append(is_posterized)
